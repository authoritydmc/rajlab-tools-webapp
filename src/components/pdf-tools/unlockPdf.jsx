...
export default function UnlockPdfTool() {
  ...
  const handleUnlock = async () => {
    ...
    try {
      ...
      // Save the document. pdf-lib saves documents without encryption by default.
      ...
      if (error.message && error.message.includes('encrypted')) {
         ...
         toast.error('Error unlocking PDF. Ensure you entered the correct password.');
      }
    } finally {
  ...
  return (
    <ToolPageLayout title="Unlock PDF" icon={<FaUnlockAlt />} breadcrumb={[{label: 'PDF Tools', path: '/merge-pdf'}]} siblings={siblings} currentPath="/unlock-pdf">
