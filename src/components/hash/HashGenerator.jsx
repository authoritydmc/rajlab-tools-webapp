...
export default function HashGenerator() {
  ...
  return (
    <ToolPageLayout title="Hash Generator" icon={<FaFingerprint />} breadcrumb={[{label: 'Encryption & Encoding Utilities', path: '/base64-encoder-decoder'}]} siblings={siblings} currentPath="/hash-generator">
