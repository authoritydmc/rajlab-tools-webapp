  ...
  return (
    <>
      <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-8">
        <div
          className={`relative rounded-lg shadow-lg p-6 w-full w-full ${isDarkMode ? 'bg-slate-900/60 backdrop-blur-xl' : 'bg-white/60 backdrop-blur-xl'} max-h-[80vh] overflow-y-auto max-w-[80vw] md:max-w-[50vw]`}
        >
