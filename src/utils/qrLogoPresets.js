...
import { SiWhatsapp, SiGooglepay, SiPhonepe, SiPaytm } from 'react-icons/si';
import { FaLink, FaMoneyBillAlt, FaWifi } from 'react-icons/fa';
...
export const PRESET_LOGOS = [
  ...
  },
  {
    id: 'upi',
    label: 'UPI',
    iconUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="20" fill="%230f172a"/><text x="50" y="52" text-anchor="middle" dominant-baseline="middle" font-family="Arial,sans-serif" font-weight="900" font-size="46" fill="%23ffffff">₹</text><text x="50" y="80" text-anchor="middle" font-family="Arial,sans-serif" font-weight="800" font-size="16" letter-spacing="3" fill="%2300BA77">UPI</text></svg>',
  ...
  },
  {
    ...
    iconComponent: SiGooglepay,
  },
  {
    id: 'phonepe',
    label: 'PhonePe',
    iconUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="20" fill="%235f259f"/><text x="50" y="58" text-anchor="middle" dominant-baseline="middle" font-family="Arial,sans-serif" font-weight="800" font-size="44" fill="%23ffffff">पे</text></svg>',
    iconComponent: SiPhonepe,
  },
  {
    id: 'paytm',
    label: 'Paytm',
    iconUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="20" fill="%2300b9f5"/><text x="50" y="56" text-anchor="middle" dominant-baseline="middle" font-family="Arial,sans-serif" font-weight="900" font-size="22" fill="%23ffffff">Paytm</text></svg>',
    iconComponent: SiPaytm,
  },
  {
    id: 'whatsapp',
    label: 'WhatsApp',
